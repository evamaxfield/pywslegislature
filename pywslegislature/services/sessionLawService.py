...
class SessionLawService(object):
    ...
    GetBillByChapterNumber = APIFunction(
        "GetBillByChapterNumber",
        [ExampleParameters.chapterNumber, ExampleParameters.session, ExampleParameters.year]
    )
    GetChapterNumbersByYear = APIFunction(
        "GetChapterNumbersByYear",
        [ExampleParameters.year]
    )
    GetSessionLawByBill = APIFunction(
        "GetSessionLawByBill",
        [ExampleParameters.biennium, ExampleParameters.billNumber]
    )
    GetSessionLawByBillId = APIFunction(
