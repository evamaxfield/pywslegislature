...
class RCWCiteAffectedService(object):
    ...
    GetLegislationAffectingRcw = APIFunction("GetLegislationAffectingRcw", {
        **ExampleParameters.biennium,
        **ExampleParameters.rcwCite
    })
    GetLegislationAffectingRcwCite = APIFunction("GetLegislationAffectingRcwCite", {
        **ExampleParameters.biennium,
        **ExampleParameters.rcwCite
    })
